  ...
  Widget build(BuildContext context) {
    return StepScroll(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        const Sub('This only changes how Oneira greets you in the morning.'),
        const SizedBox(height: 26),
...
/// Mirrors the retrieval corpus. Keep in sync with `oneira/src/sources.mjs`
/// and the library named in `oneira/src/prompt.mjs`.
    ...
    return StepScroll(
      ...
      children: [
        ...
        const Sub(
          ...
          'Oneira reads from three public-domain books and quotes them directly.',
        ),
        const SizedBox(height: 26),
        ...
        const InfoCard(
          ...
          body: 'Oneira tells you so plainly, instead of forcing '
              'an irrelevant quote.',
        ),
      ],
    );
    ...
    return StepScroll(
      ...
      children: switch (status) {
        MicStatus.denied => [
            ...
            const SizedBox(height: 12),
            const Sub(
              'Oneira works exactly the same way typed. Every reading, symbol '
        ...
        MicStatus.granted => [
            ...
            const SizedBox(height: 12),
            const Sub(
              'Tomorrow morning, open Oneira, tap the microphone, and say '
        ...
        _ => [
            ...
            const Sub(
              ...
              'far better — but only if you let Oneira listen.',
            ),
            const SizedBox(height: 26),
            const InfoCard(
              icon: Icons.schedule,
