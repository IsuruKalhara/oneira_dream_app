...
ws.on('finish', () => {
  ...
  console.log('\nNext:');
  console.log(`  npx wrangler vectorize create dreamlore-kb --dimensions=${index.meta.dim} --metric=cosine`);
  console.log('  npx wrangler vectorize insert dreamlore-kb --file=data/vectorize.ndjson');
});
