# Oneira — Growth Plan: competitors, rankings, and income
...
1. **Name collision on Google Play.** An app called *"Oneira - Dream Journal"*
   already exists (`com.oneirapp.oneira`, ~50 installs, **3.4★**). It's too
...
3. **The category's loudest complaint is billing dark patterns.** DreamApp has
   ...
   Dream Interpreter AI gives 3 free readings ever, then walls. Oneira's
...
| Field | Value |
|---|---|
| iOS title (30) | `Oneira: Dream Journal & AI` |
...
| Play title (30) | `Oneira: AI Dream Journal` *(also splits you from the Play squatter)* |
...
2. **The moat nobody can copy: your app's anonymized statistics.** "Among N
   Oneira users who logged snake dreams, X% tagged fear; the most co-occurring
...
4. **Architecture:** `oneira.app/dream-dictionary/` subfolder (authority flows
...
3. **Publish your own honest comparison page** ("Oneira vs Oniri vs
...
| When | Do |
|---|---|
| **Pre-launch (now)** | Fix list from AUDIT.md ✅ · deploy Worker (LAUNCH.md) · trademark check on "Oneira" · reserve subreddit/handles · TestFlight cohort of 10–20 who will rate in week one |
