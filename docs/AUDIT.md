# Oneira — August 2026 deep audit: findings & fixes
### A Bitfuzed product
...
| Repo path contains `1$` → `flutter test` breaks in-place | Tests run green from a `$`-free copy (`/tmp/oneira-test`); **recommend renaming the parent folder** | — |
